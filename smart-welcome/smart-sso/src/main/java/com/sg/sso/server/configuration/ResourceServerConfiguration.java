package com.sg.sso.server.configuration;

import com.sg.framework.exception.BaseAccessDeniedHandler;
import com.sg.framework.exception.BaseAuthenticationEntryPoint;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED)
                .and()
                .authorizeRequests()
                .antMatchers("/login/**","/oauth/**","/weChat/**").permitAll()
                // 监控端点内部放行
