package com.sg.gateway.server.configuration;

import com.sg.gateway.server.exception.JsonAccessDeniedHandler;
import com.sg.gateway.server.exception.JsonAuthenticationEntryPoint;
import com.sg.gateway.server.exception.JsonSignatureDeniedHandler;
import com.sg.gateway.server.filter.*;
import com.sg.gateway.server.locator.ApiResourceLocator;
import com.sg.gateway.server.oauth2.RedisAuthenticationManager;
import com.sg.gateway.server.service.IBaseAppService;
import com.sg.gateway.server.service.impl.AccessLogService;
