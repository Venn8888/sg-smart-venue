...
import com.sg.common.security.BaseUserDetails;
import com.sg.gateway.server.util.ReactiveWebUtil;
...
public class AccessLogService {
    ...
    public void sendLog(ServerWebExchange exchange, Exception ex) {
        ...
        try {
            ...
            String ip = ReactiveWebUtil.getRemoteAddress(exchange);
            ...
            amqpTemplate.convertAndSend(Constants.QUEUE_ACCESS_LOGS, map);
        } catch (Exception e) {
