package com.sg.gateway.server.locator;

import com.google.common.collect.Lists;
import com.sg.common.event.RemoteRefreshRouteEvent;
...
public class JdbcRouteDefinitionLocator implements RouteDefinitionLocator, ApplicationListener<RemoteRefreshRouteEvent> {
    ...
    private final static String SELECT_ROUTES = "SELECT * FROM API_ROUTE_RULE WHERE is_active='Y' and status = 'Y'";
