...
public class TicketSaleCountExcel implements Serializable {
    ...
    @Excel(name = "单据编号", orderNum = "1", width = 20)
    ...
    @Excel(name = "销售", orderNum = "5", width = 25)
    private String saler;

    @Excel(name = "票单价", orderNum = "6")
    private BigDecimal price;

    @Excel(name = "票数量", orderNum = "7")
    private Integer count;

    @Excel(name = "应收", orderNum = "8")
    private BigDecimal dueAmount;

    @Excel(name = "折扣（值）", orderNum = "9")
    private BigDecimal discountAmount;

    @Excel(name = "实收", orderNum = "10")
    private BigDecimal amount;

    @Excel(name = "支付方式", orderNum = "11")
    private String channel;

    @Excel(name = "订单日期", orderNum = "12", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
