...
public class BaseClientDetailsImpl implements ClientDetails , Serializable {
    ...
    public BaseClientDetailsImpl() {
    }

    public BaseClientDetailsImpl(ClientDetails prototype) {
        this();
    ...
    public BaseClientDetailsImpl(String clientId, String resourceIds,
    ...
    @org.codehaus.jackson.annotate.JsonProperty("authorities")
    @com.fasterxml.jackson.annotation.JsonProperty("authorities")
    public void setAuthoritiesExt(
            Collection<BaseAuthority> authorities) {
        this.authorities = new ArrayList<GrantedAuthority>(authorities);
    }
    ...
    public boolean equals(Object obj) {
        ...
        BaseClientDetailsImpl other = (BaseClientDetailsImpl) obj;
